var NULL="";
var lcm=function(NumOne, NumTwo, STOPinput, BigNum, MiniNum, results, CalcNumOne, CalcNumTwo, BigCheck, CalcNumOneRes, CalcNumTwoRes, lcmResult) {
  console.log("clicked");
  results=[];
    ...
    if(BigCheck===true)  {
      ...
      while(CalcNumOne!==0) {
        ...
        if(BigCheck===false) {
          ...
          lcmResult= (NumOne*NumTwo)/CalcNumTwo;
          return lcmResult;
